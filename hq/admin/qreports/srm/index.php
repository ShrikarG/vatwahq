...
require '../../connect.php';
                ...
                if($result = $db->query("SELECT * FROM qr_staff where vacc='SRM vACC'"))
                {
		            if($result->num_rows)
			    {	
            ...
            $events = array();
                ...
                if($result = $db->query("SELECT * FROM events where vacc='SRM vACC'"))
                {
		            if($result->num_rows)
			    {	
				while($row  = $result->fetch_object())
            ...
            $atc = array();
                ...
                if($result = $db->query("SELECT * FROM atc_roster where vacc='SRM vACC' AND status='Resident'"))
                {
		            if($result->num_rows)
			    {	
				while($row  = $result->fetch_object())
    ...
    <section class="content-header">
      <h3><rw1>
		...
		<tbody>
            ...
            <input type = "hidden" name = "vacc" value = "SRM vACC">
            </div>
            </div>
            <br>
            <center>
...
?>      
		...
		<tbody>
            ...
            <input class = "form-control" name="vacc" value="SRM vACC" type="hidden" />
            </div>
            <br>
            <center>
            <input class="btn btn-info" name="save" type="submit" />
 ...
 <div class="card">
     ...
     <form name = "staff" action="admin/qreports/insert/q_status.php" method="POST">
            ...
            <input class = "form-control" name="vacc" type="hidden" value="SRM vACC" />
